class Product < ActiveRecord::Base
  ...
  scope :serach_by_keyword, ->(keyword, match, context = "tags", tag_name = nil) {
    products =
  ...
  scope :search, ->(keyword, date, today, match, tag_name = nil) {
    products = serach_by_keyword(keyword, match, 'tags', tag_name)
